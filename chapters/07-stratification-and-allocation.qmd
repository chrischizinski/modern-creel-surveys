...
#| fig-alt: "Calendar grid from April through October 2024 with colored cells marking sampled days. Weekday cells (blue), weekend cells (orange), and high-use holiday cells (a third color) are scattered across the months, showing roughly proportional coverage of each stratum."
