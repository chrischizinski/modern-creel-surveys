...
biomass_est <- est_biomass(lf_weighted, a = a, b = b)
biomass_est

biomass_walleye <- biomass_est |> filter(species == "Walleye")
biomass_walleye
```
